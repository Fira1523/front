<template>
      <nav class="flex justify-between border-b pb-3 pt-5 -ml-10 pl-10 -mt-10 pr-16 -mr-10  border-neutral-300 sticky top-0 bg-white z-50">
    <div>
      <div class="flex">
     <a href="#" class="text-2xl font-bold text-black block ">EthioLance<span class="text-green-400 text-4xl">.</span> </a>
        ...
        <div class="relative ml-2 mt-2">
          ...
          <div v-if="dropdownOpen" class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded z-20">
            <router-link to="/BalancePro" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">Balance</router-link>
            <router-link to="/WatchProposal" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">proposal</router-link>
          </div>
        </div>
      </div>
