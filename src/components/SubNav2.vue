  ...
  <header class="fixed top-0 left-72 mr-96 -right-96 bg-white shadow-md z-10">
    <div class="flex justify-between items-center px-6 py-4">
      <div class="relative flex items-center">
        <router-link to="/ClientDashboard" class="text-3xl text-cyan-600 font-semibold">Professional</router-link>
        ...
        <div classc="relative ml-2">
          ...
          <div v-if="dropdownOpen" class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded z-20">
            <router-link to="/ProBalance" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">Balance</router-link>
