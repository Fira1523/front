...
const menuGroups = ref([
  {
      ...
      
   {
      ...
      },
      {
        ...
        icon: 'paper-plane',
        label:'chat',
        route:'/ProChatTemplate'

      },
            {
        
        icon: 'diagram-project',
        label:'Terminated Jobs',
        route:'/showFinishedJobs'
      ...
      //   route: '#',
      //   children: [
      //       { label: 'Payment Method', route: '/payment-method' },
      //     ]
      // },
      ...
      //   route: '#',
      //   children: [
      //       { label: 'rettingNumber', route: '/rettingNumber' },
      //     ]
      // },
      // {
      //   icon: `calendar`,
...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
              <img src="\photo_2024-10-08_21-55-44.jpg" alt="" class="h-28 w-60 -mb-10">
      </router-link>
