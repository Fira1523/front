...
<div  class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
  <div v-if="registrationComplete" class="p-6 border-l-4 border-green-500 -6 rounded-r-xl bg-green-50">
    <div class="flex">
      ...
      <div class="ml-3">
        <div class="text-sm text-green-600">
          <p>Your have Successfully Updated Your Profile.😊  <router-link to="/ProProfile" class=" ml-6 bg-gray-900 active:bg-gray-700 text-sm font-semibold px-6 py-3 rounded shadow text-black hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="button">
    ...
    v-if="!registrationComplete"
      class="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mt-16">

      <div v-if="!profileLoaded">
        <h1 class="text-2x1 font-bold justify-center text-cyan-800  ml-40">
          LOADING PROFILE ...
        </h1>
      </div>
      <div v-if="profileLoaded" class="">
        <div class="relative z-20 h-35 md:h-65">
          <img :src="photo"  alt="profile cover"
            class="h-80 w-full rounded-tl-sm rounded-tr-sm object-cover object-center " />
                <div class="ml-20 -mt-32">

            <img :src="photo" alt="" class="w-44 h-44 rounded-full ml-96 ">
            </div>
          <div class="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4 -mb-24">
            <label for="cover"
        ...
        <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5 mt-32 ml-20" >
      
          <div class="mt-6">
            <h3 class="block uppercase text-gray-700 text-xs font-bold mb-2 ">
              {{ professionalData.user.full_name }}
            </h3>
            <p class="block uppercase text-gray-700 text-xs font-bold mb-2 ">graduated @{{
              professionalData.freelancer.graduation_year }}</p>
            <div>
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Full name:</label>
                  <input type="text" name="full_name"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80 mr-9"
                    required v-model="model.user.full_name" /><br />
                </div>
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Email:</label>
                  <input type="text" name="full_name"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80 "
                    required v-model="model.user.email" /><br />
                </div>
              </div>
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Phone
                    number:</label>
                ...
                <div>
                  ...
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Address:</label>
                  <input type="text" name="address"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80"
                    required v-model="model.user.address" />
                </div>
              </div>
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Experience:</label>
                  <input type="number" name="experience"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80 mr-9"
                    required v-model="proffesionalModel.professional.experiance" /><br />
                </div>
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-60">Certificate:</label>
                  <input type="file" @change="handleCertificate" name="certificate"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80"
                    required />
                </div>
              </div>
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-56">Educational
                    status:</label>
                  <select name="" required v-model="proffesionalModel.professional.educational_status_id"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80 mr-9">
                ...
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">College:</label>
              ...
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-60">Graduation
                    year:</label>
                ...
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Portfolio:</label>
                  <input type="file" @change="handlePortfolio" name="certificate"
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80" /><br />
                </div>
              </div>
              <div class="flex justify-center mt-10">
                <div>
                  <label for="" class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Skills:</label>
                  <select name="" required v-model="proffesionalModel.professional.skill_lists_id" multiple
                    class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-80 mr-9">
                ...
                <div>
                  ...
                  <label class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Country:</label>
              ...
              <div class="mr-4">
                <div class="justify-center mr-96 mt-10 ml-6">
                  <label class="block uppercase text-gray-700 text-xs font-bold mb-2 -ml-64">Photo:</label>
              ...
              <button @click="updateProfile"
                class="bg-gray-900 mt-10 text-black active:bg-gray-700 text-sm font-bold uppercase px-40 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
            ...
            <!-- <div class="mx-auto mt-10 max-w-180">
              <h4 class="block uppercase text-gray-700 text-xs font-bold mb-2 cursor-pointer">About Me</h4>
              <p class="mt-4.5 text-sm font-normal"></p>
            </div> -->

            <!-- <div class="mt-6.5">
              <h4 class="block uppercase text-gray-700 text-xs font-bold mb-2  cursor-pointer">Follow me on</h4>
...
export default {
  ...
  data() {
    return {
      ...
      infoUrl: 'http://127.0.0.1:8000/api/professional-profile',
      //UpUrl: 'http://127.0.0.1:8000/api/updateProfessionalProfile',
      nextPressed: false,
      termsAccepted: true,
      model: {
        user: {
  ...
  methods: {
    fetchProfessionalData() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.proffesionalModel.professional.skill_lists_id =
            response.data.data.freelancer.skill_lists_id
          this.proffesionalModel.professional.educational_status_id =
            response.data.data.freelancer.educational_status_id
          this.model.user.address = response.data.data.user.address
          this.proffesionalModel.professional.experiance = response.data.data.freelancer.experiance
          this.proffesionalModel.professional.certificate = response.data.data.freelancer.certificate
          this.proffesionalModel.professional.portfolio = response.data.data.freelancer.portfolio
          this.proffesionalModel.professional.college = response.data.data.freelancer.college
          this.proffesionalModel.professional.graduation_year =
            response.data.data.freelancer.graduation_year
    ...
    updateProfile() {
      ...
      formData.append('skill_list_id', this.proffesionalModel.professional.skill_lists_id)
      ...
      axios
        .post('http://127.0.0.1:8000/api/updateProfessionalProfile', formData, {
          headers: {
        ...
        .then((response) => {
          ...
          this.registrationComplete = !this.registrationComplete
