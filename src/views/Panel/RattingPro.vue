...
mounted(){
this.model.ratting.taker_id = localStorage.getItem('clientID')
this.model.ratting.giver_id = localStorage.getItem('user_id')
console.log('giver_id',this.model.ratting.giver_id)
console.log('taker_id',this.model.ratting.taker_id)
this.model.ratting.project_id = localStorage.getItem('PID')
