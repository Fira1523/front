        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div
                ...
                <div class="col-span-1 hidden items-center sm:flex  ">
                   ...
                   <div class="col-span-1 flex items-center ml-64 w-20">
                    <p class="font-medium ">API Adress</p>
                </div>

                <div class="col-span-1 flex items-center ml-52">
   ...
   <div v-if="isLoading" class="ml-20">
            ...
            <div v-else>
                ...
                <div v-for="payMethod in payMethods" :key="payMethod.id"
                    ...
                    <!-- <div class="col-span-1 hidden items-center sm:flex">
                        <p class="text-sm font-medium text-black dark:text-white">{{ payMethod.id }}</p>
                    </div> -->
                    <div class="col-span-1 flex items-center ">
                        <p class="text-sm font-medium text-black dark:text-white ">{{ payMethod.name }}</p>
                    </div>
    <div class="col-span-1 hidden items-center sm:flex">
                        <p class="text-sm font-medium text-black dark:text-white ml-64">{{ payMethod.api_address }}</p>
                    </div>
                    ...
                    <div class="col-span-1 flex items-center ml-96">
                        <div class="py-5 px-4 ml-48">
                            <div class="flex items-center space-x-3.5">
                              ...
                              <ficon :icon="['fas', 'pen-to-square']" @click="startEdit(payMethod)" />
                             <ficon :icon="['fas', 'trash']" @click="deletePaymethod(payMethod.id)"/>
...
export default {
    ...
    methods: {
        ...
        editpayMethod() {
            ...
            const updatedMethod = { payment_name: this.payment_name };

            axios.put(`http://127.0.0.1:8000/api/paymentmethod/${this.paymentId}`, updatedMethod)
                .then(res => {
        ...
        addpayMethod() {
            this.model.payMethod.payment_name = this.payment_name;
            axios.post('http://127.0.0.1:8000/api/paymentmethod', this.model.payMethod)
                .then(res => {
        ...
        deletePaymethod(paymentMtdId) {
            if (confirm('Are you sure you want to delete this payment method?')) {
                axios.delete(`http://127.0.0.1:8000/api/paymentmethod/${paymentMtdId}`)
                    .then(res => {
