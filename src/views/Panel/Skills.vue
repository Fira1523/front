  ...
  <DefaultLayout3> 
    <SubNav3 />
        <div class="font-serif ml-56" ref="scrollableDiv">
          <h1 class="-ml-56 text-black text-2xl font-semibold">Skills</h1>
            <div class="mb-2 ml-32">
                <div v-if="showcreate" class="shadow-md shadow-gray-400 w-72 h-32 ml-20">
                                 <div>
          <label for="" class="font-serif  text-md">Skill name:</label><br>
          ...
          <input type="number" name="certificate" class="border-2 mt-3 lg:w-60 w-48 mb-3 border-gray-200 focus:outline-none h-8 rounded-md lg:mr-1 bg-white" required v-model="code">
                ...
                <button @click="createPaymethod" class="btn bg-cyan-800 text-white py-2 px-8 -ml-80 rounded-md mt-10 mb-2">
                    Add Category
                </button>
            </div>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div
                ...
                <div class="col-span-2 flex items-center w-full ml-20">
            ...
            <div v-else>
                ...
                <div v-for="skill in skills" :key="skill.id"
                    ...
                    <div class="col-span-2 hidden items-center sm:flex ml-20">
                        <p class="text-sm font-medium text-black dark:text-white">{{skill.skill_name}}</p>
                    </div>
                    <div class="col-span-1 flex items-center ">
                        <p class="text-sm font-medium text-black dark:text-white ml-96">{{skill.code}}</p>
                    </div>
